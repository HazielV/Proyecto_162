        ...
        <div className="font-normal text-6xl white  px-8 py-6  w-4/5  flex  ">
          <div className="">
            <p className="max-w-2xl  ">
              Comprende nuestra Filosofía,
              Innovación y Compromiso con la
        ...
        <div className="grid grid-cols-2 w-4/5 px-8 py-6 gap-24">
          <div className="flex flex-col gap-5 pb-10 pt-6 border-gray-600 border-t-2">
            <div className="text-2xl font-medium">
              Transformación en la Gestión de la
              Información Médica
            </div>
            <p className="text-lg">
              La salud electrónica representa un
              cambio transformador en la gestión
              de la información médica, destacando
              pilares como registros médicos
              electrónicos (EMR), sistemas de
              información de salud y telemedicina.
              Los EMR, en particular, centralizan
              y digitalizan registros médicos,
              mejorando la accesibilidad y
              coordinación entre profesionales de
              la salud.
            </p>
          </div>
          <div className="flex flex-col gap-5 pb-10 pt-6 border-gray-600 border-t-2">
            ...
            <p className="text-lg">
              La interoperabilidad, esencial en
              salud electrónica, cobra importancia
              al integrar sistemas de agenda
              médica. La capacidad de intercambio
              efectivo de información entre
              sistemas optimiza la gestión de
              citas médicas, mejorando la
              eficiencia y la experiencia del
              paciente. Facilita la coordinación
              entre profesionales y contribuye a
              una atención más personalizada.
            </p>
          </div>
          <div className="flex flex-col gap-5 pb-10 pt-6 border-gray-600 border-t-2">
            <div className="text-2xl font-medium">
              Desafíos en Seguridad de la
              Información:
            </div>
            <p className="text-lg">
              A pesar de sus beneficios, la salud
              electrónica enfrenta desafíos,
              destacando la seguridad de la
              información en salud. La
              preservación de la confidencialidad
              e integridad de los datos del
              paciente requiere medidas de
              seguridad y estándares robustos. La
              gestión adecuada de la seguridad
              informática se convierte en un
              requisito indispensable para
              garantizar la confianza de
              profesionales y pacientes en los
              sistemas electrónicos.
            </p>
          </div>
          <div className="flex flex-col gap-5 pb-10 pt-6 border-gray-600 border-t-2">
            <div className="text-2xl font-medium">
              Perspectiva Centrada en el Usuario y
              Consideraciones Éticas
            </div>
            <p className="text-lg">
              En el diseño de sistemas de
              información, la perspectiva centrada
              en el usuario es crucial para la
              aceptación y eficacia. La usabilidad
              y la experiencia del usuario son
              clave. La integración de tecnologías
              como la inteligencia artificial
              ofrece mejoras, pero debe ir de la
              mano con consideraciones éticas y
              legales, como las establecidas por
              normativas como la Ley HIPAA en los
          ...
          <div className="flex flex-col w-4/6 px-8 py-6 items-center relative">
            <div className="flex items-center gap-10">
              ...
              <p className="flex-1 text-xl">
                ...
                pacientes enfrenta desafíos
                sustanciales. La falta de un
                sistema eficiente y unificado para
                registrar ingresos del paciente,
                gestionar el sistema de seguros,
                agendar citas médicas y acceder al
                historial clínico de manera rápida
                y segura ha generado obstáculos
                significativos en la entrega
            ...
            <div className="flex items-center gap-10 relative -top-12">
              ...
              <div className="grid grid-cols-2 gap-10 flex-1">
                <p className=" text-xl">
                  ...
                  dispersa en diversos sistemas y
                  formatos, dificultando la
                  creación de un panorama
                  coherente de su historial
                  médico.
                </p>
                <p className=" text-xl">
                  <span className="font-medium">
                    Proceso Manual en Datos
                    Financieros:
                  </span>{" "}
                  El registro de ingresos y la
                  gestión de seguros se realizan
                  manualmente, lo que puede
                  resultar en errores, demoras y
                ...
                <p className=" text-xl">
                  ...
                  centralizado para agendar citas
                  médicas ha generado confusiones,
                  retrasos y una experiencia menos
                ...
                <p className=" text-xl">
                  ...
                  relevante sobre el paciente es
            ...
            <div className="flex items-center gap-10 relative -top-24">
              ...
              <p className="flex-1 text-xl">
                Estos desafíos impactan
                directamente en la calidad de la
                atención médica proporcionada. La
                falta de integración y eficiencia
                en la gestión de datos
                financieros, seguros, citas
                médicas y registros clínicos
                afecta la capacidad de los
                profesionales de la salud para
                ofrecer una atención completa y
            ...
            <div className="flex items-center gap-10 relative -top-36">
              ...
              <p className="flex-1 text-xl">
                ...
                integral que aborde los desafíos
                mencionados es esencial para
                mejorar la eficiencia operativa,
                la coordinación de la atención y,
                en última instancia, la calidad de
                los servicios de salud. Se
                requiere una solución que optimice
                el registro de ingresos,
                simplifique la gestión de seguros,
                facilite el agendamiento de citas
                y mejore el acceso al historial
                clínico, proporcionando una
                experiencia integrada y centrada
                en el paciente.
              </p>
            </div>
          </div>
        ...
        <div className="min-h-[100vh] flex justify-center items-center flex-col  gap-12 w-full  py-14 ">
          ...
          <div className="w-4/5 px-8 py-6 text-2xl">
            <p>
              ...
              es la falta de un sistema integrado
              y eficiente para la gestión de la
              información del paciente, incluyendo
              el registro de ingresos, sistema de
              seguros, agendamiento de citas
              médicas y acceso al historial
              clínico, que está afectando
              negativamente la calidad de la
              atención médica y la experiencia
              general del paciente en el entorno
          ...
          <div className="flex  w-3/5 pt-12 text-3xl gap-10 border-t">
            ...
            <div className="">
              ...
              <p className="text-2xl">
                ...
                financiamiento para implementar
          ...
          <div className="flex  w-3/5 pt-12 text-3xl gap-10 border-t">
            ...
            <div className="">
              ...
              <p className="text-2xl">
                Falta de capacitación adecuada del
                personal de atención médica en el
          ...
          <div className="flex  w-3/5 pt-12 text-3xl gap-10 border-t">
            ...
            <div className="">
              ...
              <p className="text-2xl">
                ...
                claro y coherente para la gestión
          ...
          <div className="flex flex-col px-8 py-6 w-4/5 pt-16 text-3xl gap-10 ">
            ...
            <div className="grid grid-cols-2 gap-10">
              <div className="text-2xl border rounded-xl p-10">
                ...
                claro y coherente para la gestión
                de la información del paciente
                podría llevar a la falta de
                estandarización en la gestión de
                la información del paciente, lo
                que podría dificultar la
                interoperabilidad entre sistemas y
                la transferencia de datos entre
                proveedores de atención médica
              </div>
              <div className="text-2xl border rounded-xl p-10">
                La falta de incentivos para la
                adopción de sistemas de salud
                electrónicos por parte de los
                proveedores de atención médica
                podría llevar a una baja tasa de
                adopción de sistemas de salud
                electrónicos.
              </div>
              <div className="text-2xl border rounded-xl p-10">
                La inadecuada capacitación para el
                personal de atención médica en el
                uso de sistemas de salud
                electrónicos podría llevar a una
                baja eficiencia en el trabajo y
                una mayor probabilidad de errores.
              </div>
              <div className="text-2xl border rounded-xl p-10">
                ...
                podría llevar a una baja tasa de
                adopción de sistemas de salud
                electrónicos, lo que podría
                limitar la cantidad de datos
                disponibles para la gestión de la
                información del paciente.
              </div>
            </div>
          </div>
        </div>
        <div className="relative w-4/5 h-[35rem]">
          <Image
            fill
            alt=""
            src={"/planificacion.jpg"}
          />
        </div>
        <div className="min-h-[100vh] flex justify-center items-center flex-col  gap-12 w-full  py-14 ">
          <div className="font-normal text-7xl white  px-8 py-6 border-dashed w-4/5 border-gray-600/40  ">
